        ...
        binding.buttonCriarConta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nome.isEmpty() && !email.isEmpty() && !senha.isEmpty() && !cidade.isEmpty() && !telefone.isEmpty()) {
                    if (checkBox1Checked) {
                        // Criar paciente
                        Paciente paciente = new Paciente(nome, email, senha, cidade, Integer.parseInt(telefone));
                    ...
                    Snackbar.make(v, "Preencha todos os campos obrigatórios", Snackbar.LENGTH_SHORT)
                            .setAction("Action", null)
                            .show();
                }
            }
